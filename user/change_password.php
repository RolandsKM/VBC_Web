...
<div class="d-flex">
    ...
    <div class="form-section" style="max-width: 20rem;">
        <!-- Initial view: only current password dummy -->
...
<script>
    $('#editPasswordButton').click(function () {
        // Hide dummy fields, show real ones
        $('#password-dummies').hide();
        $('#password-inputs').show();

        // Clear and focus the first real input
    ...
    $('#savePasswordButton').click(function () {
        ...
        $.post('../database/change_password_handler.php', {

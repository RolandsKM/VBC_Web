        ...
        <div class="admin-body ">
            ...
            <div class="container mt-4">
                ...
                <table class="table table-bordered w-50">
                    ...
                    <tr><th>IP adrese</th><td><?= htmlspecialchars($user['ip_address']) ?></td></tr>
                ...
                <form method="POST" class="d-flex gap-2">
                    ...
                    <?php if (!$user['banned']): ?>
                        ...
                        <button type="submit" name="ipban" class="btn btn-dark">Bloķēt ar IP</button>
                    <?php else: ?>
